/*
    ...
    - Fazer os testes
    - Fazer interface (boneco, errorsList...)

    - Módularizar (sugestões):
        * pegar palavra secreta (check)
        * verificar letra
        * imprimir jogo (desenho, errorsList...)
        * verificar se letra digitada é igual
*/

// import words from "./words.js";

// const index = Math.round(Math.random() * words.length);
// const secretWord = words[index].toUpperCase();
