...
export function isFutureDraw(board, currentPlayer){
    ...
    //rodando um forEach de 3 posiçoes lendo possibilidade de vitória     
        slot.forEach((index)=>{
            ...
            if(players.x === 2 && players.o === 0 && players.empty === 1 && currentPlayer === PLAYER2){
                result = 1;
                return true;
            }
            if(players.o === 2 && players.x === 0 && players.empty === 1 && currentPlayer === PLAYER1){
                result = 1;
                return true;
            }
            ...
            if(players.x === 2 && players.o === 0 && players.empty === 2 && currentPlayer === PLAYER2){
                twoTrueDraw++;
                result = 1;
                return true;
            }
            if(players.o === 2 && players.x === 0 && players.empty === 2 && currentPlayer === PLAYER1){
                twoTrueDraw++;
                result = 1;
                return true;
            }
